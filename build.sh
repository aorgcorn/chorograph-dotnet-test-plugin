#!/bin/bash
# Assembles and publishes ChorographDotNetTestPlugin.bundle.zip to GitHub Releases,
...
REPO=aorgcorn/chorograph-dotnet-test-plugin
BUNDLE="${NAME}.bundle"
...
<dict>
    ...
    <string>ChorographDotNetTestPlugin</string>
    <key>CFBundleIdentifier</key>
    <string>com.aorgcorn.chorograph.plugin.dotnet-test</string>
